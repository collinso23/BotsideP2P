...
#
######################################################################
# modified slightly to fit the needs of a BotNet For CS460 uiuc Class#
######################################################################
...
class BitcoinRPC:
    ...
    def rpc(self, method, params=None):
        self.OBJID += 1
        obj = { 'version' : '1.1','method' : method,'id' : self.OBJID }
        if params is None:
            obj['params'] = []
        else:
            obj['params'] = params
...
if __name__ == '__main__':
    ...
    settings['rpcuser'] = sys.argv[1]
    settings['rpcpass'] = sys.argv[2]
